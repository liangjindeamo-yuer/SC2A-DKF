...
class SIDDDataset(Dataset) :
    ...
    def getPathList(self) :
        # Get Dataset Path
        noisyPath = join(self.dataroot, "noisy") 
        cleanPath = join(self.dataroot, "clean")
        ...
        noisyNameList = [imageName for imageName in noisyPathList if ".png" in imageName or ".PNG" in imageName]
        cleanNameList = [imageName for imageName in cleanPathList if ".png" in imageName or ".PNG" in imageName]
