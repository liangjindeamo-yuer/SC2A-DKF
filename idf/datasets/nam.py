...
class NAMDataset(Dataset) :
    def __init__(self, dataroot:str, patch_size:int, augmentation:bool,
        ...
        super(NAMDataset, self).__init__()
    ...
    def getPathList(self) :            
        noisyPath = join(self.dataroot, "input_crops")
        cleanPath = join(self.dataroot, "target_crops")
        ...
        noisyNameList = [imageName for imageName in noisyPathList if ".png" in imageName]
        cleanNameList = [imageName for imageName in cleanPathList if ".png" in imageName]
